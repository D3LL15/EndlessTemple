...
//	[window_ addSubview:navController_.view];	// Generates flicker.
    ...
    for (int x = 0; x <= 4; x++)
    {
        ...
        [[[Engine sharedInstance] highScores] replaceObjectAtIndex:x withObject:number];
        number = [array2 objectAtIndex:x];
        [[[Engine sharedInstance] highScoreNames] replaceObjectAtIndex:x withObject:number];
    }
...
-(void) applicationDidEnterBackground:(UIApplication*)application
{
    ...
    NSDictionary *plistDict = [NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:[[Engine sharedInstance] playerX],[[Engine sharedInstance] playerY],[[Engine sharedInstance] highScoreNames],[[Engine sharedInstance] highScores],[[Engine sharedInstance] alive], [[Engine sharedInstance] goreOn], [[Engine sharedInstance] musicOn], [[Engine sharedInstance] sfxOn], [[Engine sharedInstance] currentScore], [[Engine sharedInstance] health], [[Engine sharedInstance] ammo], [[Engine sharedInstance] currentLevel], [[Engine sharedInstance] saved], nil] forKeys:[NSArray arrayWithObjects:@"playerx", @"playery", @"highscorenames", @"highscores",@"alive",@"gore",@"music",@"sfx",@"score",@"health",@"ammo",@"level",@"saved", nil]];
